    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Sifre Sıfırlama Talebi</h4>
                        <?php if ($errors): ?>
                        ...
                        <form method="post">
                            ...
                            <button class="btn btn-primary">Sıfırlama E-Postası Gönder</button>
                        </form>
                        <div class="mt-3 text-center">
                            <a href="/index.php">Giriş Yap</a> | <a href="/register.php">Kayıt Ol.</a>
                        </div>
                    </div>
                </div>
            </div>
