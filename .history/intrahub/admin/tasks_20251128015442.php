            ...
            <div class="card-body">
                ...
                <form method="post" class="row g-3">
                    ...
                    <div class="col-12"><textarea name="description" class="form-control"
                            placeholder="Açıklama"></textarea></div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3"><input name="due_date" type="date" class="form-control"></div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php foreach ($tasks as $t): ?>
                    <tr>
                        <td><?= e($t['id']) ?></td>
                        <td><?= e($t['title']) ?><br><small><?= e($t['description']) ?></small></td>
                        <td><?= e($t['assignee'] ?? '—') ?></td>
                        <td><?= e($t['status']) ?></td>
                        <td><?= e($t['creator'] ?? '—') ?></td>
