...
<div class="modal-overlay" id="eventModal"
    style="display: none; position: fixed; top:0; left: 100px;; width:100%; height:100%; background: rgba(0,0,0,0.5); z-index: 1000; justify-content: center; align-items: center;">
        ...
        <form id="eventForm">
            ...
            <div class="d-flex gap-2" style="gap: 10px;">
                ...
                <button type="button" class="btn btn-secondary" onclick="closeEventModal()"
                    style="background: transparent; border: 1px solid var(--border-color); color: var(--text-muted); width: 100%; border-radius: 12px;">İptal</button>
            </div>
        </form>
    </div>
</div>
