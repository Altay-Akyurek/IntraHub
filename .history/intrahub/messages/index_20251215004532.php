    ...
    <div class="row"
        ...
        <div class="glass-card" style="padding: 0; overflow: hidden; display: flex; flex-direction: column;">
            <div
                ...
                <h5
                    style="margin: 0; font-weight: 700; background: linear-gradient(to right, var(--primary-color), var(--secondary-color)); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                    Sohbetler</h5>
...
<div class="modal-overlay" id="newChatModal"
    ...
    <div class="glass-card" style="width: 100%; max-width: 400px; margin: 2rem;">
        ...
        <div class="mt-3 text-end">
            <button class="btn btn-secondary btn-sm" onclick="openNewChatModal()"
                onclick="document.getElementById('newChatModal').style.display='none'">
                <i class="fas fa-plus"></i> <span class="d-none d-md-inline">Kapat</span>
            </button>
