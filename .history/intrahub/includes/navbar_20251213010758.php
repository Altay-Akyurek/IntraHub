    ...
    <div class="container d-flex justify-content-between align-items-center" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="nav-links">
            ...
            <?php if (isset($currentUser['role']) && $currentUser['role'] === 'admin'): ?>
                <a href="admin/index.php" class="btn btn-sm" style="color: var(--secondary-color); margin-right: 10px;">Yönetim</a>
            <?php endif; ?>
            
            <a href="logout.php" class="btn btn-sm" style="color: var(--text-muted); border: 1px solid var(--border-color); padding: 5px 10px; border-radius: 8px;">
...
<!-- Complaint Modal -->
<div class="modal-overlay" id="complaintModal" style="display: none; position: fixed; top:0; left:0; width:100%; height:100%; background: rgba(0,0,0,0.5); z-index: 2000; justify-content: center; align-items: center;">
    <div class="glass-card" style="width: 100%; max-width: 500px; margin: 2rem;">
        <h5 class="mb-3">Şikayet veya Öneri Kutusu</h5>
        <form id="complaintForm">
            <div class="mb-3">
                <textarea name="content" class="form-control" rows="4" placeholder="Görüşleriniz bizim için değerli..." required style="background: rgba(0,0,0,0.2);"></textarea>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                <button type="button" class="btn btn-secondary" onclick="document.getElementById('complaintModal').style.display='none'">İptal</button>
