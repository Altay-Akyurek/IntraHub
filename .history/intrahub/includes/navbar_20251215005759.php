<nav class="navbar">
    <div class="container d-flex justify-content-between align-items-center"
        ...
        <a class="navbar-brand" href="../intrahub/dashboard.php">IntraHub</a>

        <?php $currentUser = current_user(); ?>
        <div class="nav-links">
            <button class="btn btn-premium-glass" onclick="openComplaintModal()">
                <i class="fas fa-bullhorn me-2"></i> Şikayet/Öneri
            </button>
            ...
            <?php if (isset($currentUser['role']) && $currentUser['role'] === 'admin'): ?>
                <a href="../intrahub/dashboard.php" class="btn btn-sm"
...
<style>
    ...
    .btn-premium-glass:hover {
        ...
        box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.2), 0 0 15px rgba(251, 191, 36, 0.2);
    }
