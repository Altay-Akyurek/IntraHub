...
<div class="modal-overlay" id="complaintModal"
        ...
        <form id="complaintForm">
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-glass-cancel px-3" onclick="closeComplaintModal()" style="
    ...
    ">
                    ...
                    <button type="submit" class="btn btn-glass-submit px-4" style="
    ...
    " onmouseover="
        ...
        this.style.boxShadow='0 12px 30px rgba(250,204,21,0.7)';
    " onmouseout="
        this.style.transform='translateY(0)';
        this.style.boxShadow='0 8px 25px rgba(250,204,21,0.45)';
    ">
